...
@Component({
  ...
  template: `
    <nb-card class="solar-card">
      <nb-card-header>All Projects</nb-card-header>
      <nb-card-body>
      <div class="row">
      <div class ="col-xxxl-4 col-md-4">
      <nb-card class="solar-card">
      <nb-card-header>Project 1</nb-card-header>
      <nb-card-body>
      ...
      <div class ="col-xxxl-4 col-md-4">
      <nb-card class="solar-card">
      <nb-card-header>Project 2</nb-card-header>
      <nb-card-body>
      ...
      <div class ="col-xxxl-4 col-md-4">
      <nb-card class="solar-card">
      <nb-card-header>Project 3</nb-card-header>
      <nb-card-body>
